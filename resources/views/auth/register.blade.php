            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="asal_pt" class="col-md-4 col-form-label text-md-end">{{ __('Perguruan Tinggi Asal') }}</label>

                            <div class="col-md-6">
                                <input id="asal_pt" type="text" class="form-control @error('asal_pt') is-invalid @enderror" name="asal_pt" value="{{ old('asal_pt') }}" required autocomplete="asal_pt" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="prodi" class="col-md-4 col-form-label text-md-end">{{ __('Program Studi Asal') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="alamat_asal" class="col-md-4 col-form-label text-md-end">{{ __('Alamat Asal') }}</label>

                            <div class="col-md-6">
                                <input id="alamat_asal" type="text" class="form-control @error('alamat_asal') is-invalid @enderror" name="alamat_asal" value="{{ old('alamat_asal') }}" required autocomplete="alamat_asal" autofocus>
