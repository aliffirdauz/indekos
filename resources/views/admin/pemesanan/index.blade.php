        ...
        <section>
            ...
            <nav class="nav-content gap-5">
                <div class="d-flex gap-3 align-items-center">
                    <img src="/assets/images/photo.webp" alt="Photo Profile" class="photo-profile" />
                    <div>
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="text-center fs-5">
                                    <a href="/admin/userlist/{{ $user->nama }}"
                                        class="badge rounded-pill text-bg-primary"><i class="bi bi-eye-fill"></i></a>
                                    <a href="/admin/userlist/{{ $user->id }}/edit"
                                        class="badge rounded-pill text-bg-warning"><i class="bi bi-pencil-square"></i></a>
                                    <form action="/admin/userlist/{{ $user->id }}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <button type="submit" class="badge rounded-pill text-bg-danger border-0"
